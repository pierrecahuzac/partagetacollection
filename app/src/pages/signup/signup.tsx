...
const Signup = () => {
    ...
    return (
        <div className="w-full h-full flex-col justify-center align-middle">
            <form action="submit"
                onSubmit={submitUser}
                className="bg-red-200 w-2/3 h-2/3 flex-col p-8  m-8 justify-center align-middle">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="username" id="username" value={credentials.username} onChange={handleInputChange} className="form_imput-email" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="password" name="passwordConfirmation" id="confirmationPassword" value={credentials.passwordConfirmation} onChange={handleInputChange} className="form_imput-password" />
                </div>
